...
var assert      = require('assert')
  ...
  , needle      = require('bluebird').promisifyAll(require('needle'))
...
Pagarme.prototype.request = function(options, cb) {
  ...
  return needle
    .requestAsync(options.method, this.url(options), requestParams, { json: true, timeout: 8000 })
    .bind(this)
    .spread(function(res, body) {
      if (res.statusCode !== 202 && res.statusCode < 400) return cb(null, body);
      var error = {
