...
Pagarme.prototype.request = function(options) {
  ...
  return needle
    .requestAsync(options.method, this.url(options), requestParams, { json: true, timeout: 5000 })
    .bind(this)
    .spread(function(res, body) {
      if (res.statusCode !== 202 && res.statusCode < 400) return body;
      var message = body.errors ? body.errors : http.STATUS_CODES[res.statusCode] || 'Unknown';
